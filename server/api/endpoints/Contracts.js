...
let showPublicContracts = function(req, res, next) {
  ...
  db.viewData(
    ...
    function(contract) {
      ...
      return contract("execution_time")
        .gt(today_timestamp)
        .and(contract("type").eq(1))
        .and(contract("status").eq(true))
        .and(contract("category").eq(req["body"]["category"]));
    },
    {
      id: true,
      uuid: true,
  ...
  db.viewData(
    ...
    function(contract) {
      ...
      return contract("execution_time")
        ...
        .and(contract("type").eq(2))
        .and(contract("status").eq(true))
        .and(contract("bettor").eq(req["body"]["account"]));
    },
    {
      id: true,
      betId: true,
